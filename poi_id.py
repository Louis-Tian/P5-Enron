...
#
# The recall on positive label is 1.0, meaning all the classifier identified all of the positive labels in the validation set. The precision of 0.385 on positive means the among all of the predicted positive, around 38.5% of them are correct (true postive). So by combining the two, when the classifier predicts someone to be POI, we can say we are 38.5% confident he/she is a POI.
...
#
# Any machine learning must performan both steps to achieve any sort of learning.
